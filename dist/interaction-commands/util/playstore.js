...
module.exports = {
    ...
    run: (client, interaction, args) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const msg = yield ((_a = interaction.channel) === null || _a === void 0 ? void 0 : _a.messages.fetch(interaction.targetId));
        let busqueda;
        if (msg) {
        ...
        google_play_scraper_1.default.search({
            ...
            google_play_scraper_1.default.app({
                ...
                const embed = new discord_js_1.MessageEmbed()
                    ...
                    .setTimestamp();
                let ñnt = yield interaction.followUp({ embeds: [embed], components: [row] });
