        ...
        play
          ...
          .then(async (gg) => {
            ...
            const embed = new Discord.MessageEmbed()
              ...
              .addField(
                "Actualizado",
                gg.updated ? relDate : "No hay datos",
                true
              )
            ...
            collector.on("collect", (interactionxd) => {
              ...
              if (id === "playstore_text") {
                ...
                msg.channel.send(
                  `${interactionxd.user} he enviado la descripción completa de la aplicación ${gg.title} a tu MD`
                );
              }
            });
            ...
            collector.on("end", () => {
              msg.channel.sendTyping();
              msg.channel
                .send("Se han acabado los 7 segundos para ver la descripción.")
                .then((a: any) => {
                  setTimeout(() => {
                    a.delete();
                  }, 10000);
          ...
          .catch((error) => {
            ...
            message
              .reply({
                content: `Ha ocurrido un error con la búsqueda: ${busqueda}`,
              })
              .then((a: any) => {
                setTimeout(() => {
                  a.delete();
