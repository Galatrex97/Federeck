...
if(guildList?.songs[parsedSi]) return message.reply("No hay una canción en esa posición.")
if(isNaN(parsedSi)) return message.reply("Debes escribir un número válido.")
guildList?.remove(parsedSi)
message.reply("Se ha quitado la canción número "+parsedSi+" de la lista de reproducción.");
