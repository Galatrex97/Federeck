import Discord, { Channel, Client, MessageEmbed, Message, Role, GuildMember, TextChannel } from "discord.js";
...
let texto = args.join(' ');
if(["@everyone", "@here"].includes(texto) && !message.member?.permissions.has("ADMINISTRATOR")) return message.reply("Para mencionar debes tener el permiso de Administrador.").then(nya => {
  nya.delete()
})
