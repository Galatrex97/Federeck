import { Client, ContextMenuInteraction, TextChannel, MessageEmbed, MessageActionRow, MessageButton } from "discord.js";
...
const row = new MessageActionRow().addComponents(
	...
	.setLabel("Sitio web de "+gg.title)
        ...
        .setTimestamp()
let ñnt: any = await interaction.followUp({embeds: [embed], components: [row]})
