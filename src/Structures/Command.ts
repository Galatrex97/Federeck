...
class BaseCommand {
    ...
    constructor(options: CommandOptions) {
        ...
        this.description = options.description || "No ha sido asignada descripción alguna a este comando.";
        this.usage = options.usage || "No han sido asignadas instrucciones de uso para este comando.";
