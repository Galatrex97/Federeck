	...
	try {
			...
			await interaction
				...
				.then(async (mssg) => {
					...
					setTimeout(async () => {
						...
						emb1.setDescription(
							'Se ha acabado el tiempo límite para usar este comando. (10 minutos)'
						)
		...
		function mathEval(input) {
			try {
				...
				if (!matched) return 'Entrada inválida'
		...
		console.log(`Ha ocurrido un error con la calculadora | Error: ${err.stack}`)
	}
}
